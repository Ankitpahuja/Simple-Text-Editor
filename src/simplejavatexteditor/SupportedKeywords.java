...
public class SupportedKeywords
{
    ...
    private String[] css = {"html", "head", "!DOCTYPE", "<ul>", "<li>", "<a>",
    ...
    private String[] html = { "<html>", "<head>", "<!DOCTYPE", "<ul>", "<li>", "<a>",
                "<b>", "<a>", "<strong>", "<div>", "<img>", "<em>", "<section>", "<table>",
                "<tr>", "<td>", "<a href>", "<body>", "Loremipsumdolorsitamet,consecteturadipiscingelit,seddoeiusmodtemporincididuntutlaboreetdoloremagnaaliqua.Uenimadminimveniam,quisnostrudexercitationullamcolaborisnisiutliquipeeacommodoconsequat.Duisauteiruredolorinreprehenderitinvoluptatevelitessecillumdoloreeuugiatnullapariatur.Excepteursintoccaecatcupidatatnonproident,suntinculpaquiofficiadeseruntmollitanimidestlaborum" };
